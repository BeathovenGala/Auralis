  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        operational: {
          blue: "hsl(200 100% 60%)",      // Primary operational blue
          slate: "hsl(220 15% 8%)",       // Dark background
          panel: "hsl(220 12% 12%)",      // Elevated panels
          success: "hsl(120 60% 45%)",    // Success/normal state
          warning: "hsl(45 90% 55%)",     // Warning state
          danger: "hsl(0 85% 55%)",       // Danger/alert state
          info: "hsl(200 100% 60%)",      // Informational
        },
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
